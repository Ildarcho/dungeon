...
public class Configuration800x600 implements Configuration {
    private final String title = "Dungeon";
    private final int windowWidth = 800;
    private final int windowHeight = 600;
    private final int minimapHeight = 100;
    private final int minimapWidth = 100;
    private final int maxFps = 50;
    private final int fov = 60;
    private final int viewColumnWidth = 7;
    ...
    private final double crosshairSize = 20;
    private final double crosshairThickness = 3;
    ...
    private final int gunSpriteHeight = 250;
